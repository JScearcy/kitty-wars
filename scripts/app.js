...
var _user$project$Main$imgHelper = F2(
	function (spritelist, index) {
		var item = A2(
			...
			A2(
				...
				index,
				_elm_lang$core$Array$fromList(spritelist)));
		var pointStr = A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'background',
						_1: A2(_user$project$Main$imgHelper, $char.spriteLocation, $char.spriteFrame)
					},
...
var _user$project$Main$incrementCharacterFrame = F2(
		...
		switch (_p0.ctor) {
			...
			case 'KeyUp':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{keyDown: false, arrow: _p0._0}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			default:
				var _p1 = A2(_elm_lang$core$Debug$log, 'Time', _p0._0);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					_elm_lang$core$Native_List.fromArray(
...
var _user$project$Main$Character = F3(
	function (a, b, c) {
		return {location: a, spriteFrame: b, spriteLocation: c};
	});
var _user$project$Main$Point = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _user$project$Main$spriteLocation = _elm_lang$core$Native_List.fromArray(
	[
		A2(_user$project$Main$Point, -5, -6),
		A2(_user$project$Main$Point, -298, -4),
		A2(_user$project$Main$Point, -593, -4),
		A2(_user$project$Main$Point, -890, -6),
		A2(_user$project$Main$Point, -1188, -7),
		A2(_user$project$Main$Point, -1480, -5),
		A2(_user$project$Main$Point, -1773, -3),
		A2(_user$project$Main$Point, -2068, -3),
		A2(_user$project$Main$Point, -2365, -5),
...
var _user$project$Main$keyDownHandlerMsg = function (_p3) {
	return _user$project$Main$KeyDown(
		_user$project$Main$keyHandler(_p3));
};
var _user$project$Main$keyUpHandlerMsg = function (_p4) {
	return _user$project$Main$KeyUp(
		_user$project$Main$keyHandler(_p4));
};
var _user$project$Main$subscriptions = function (model) {
	var _p5 = model.keyDown;
	if (_p5 === false) {
		return _elm_lang$core$Platform_Sub$batch(
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$keyboard$Keyboard$downs(_user$project$Main$keyDownHandlerMsg),
					_elm_lang$keyboard$Keyboard$ups(_user$project$Main$keyUpHandlerMsg)
				]));
	} else {
		return _elm_lang$core$Platform_Sub$batch(
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$keyboard$Keyboard$downs(_user$project$Main$keyDownHandlerMsg),
					_elm_lang$keyboard$Keyboard$ups(_user$project$Main$keyUpHandlerMsg),
					A2(_elm_lang$core$Time$every, 250 * _elm_lang$core$Time$millisecond, _user$project$Main$Tick)
				]));
	}
};
